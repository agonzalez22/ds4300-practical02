...
def get_llm_response(query: str, response: str, model="mistral"):
    ...
    prompt = f"You are an Artifical Intelligence computer assitant to help the user pass their test. Given the query: {query}, and the response: {response}, summarize the information."
